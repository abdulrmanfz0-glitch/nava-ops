          ...
          {[
            {
              ...
              description: 'Based on your current growth trajectory, consider opening a new location in high-traffic areas.',
              severity: 'info',
              icon: TrendingUp,
              color: 'blue'
            },
            {
              ...
              description: 'Historical data shows 30% revenue increase during upcoming peak season. Prepare inventory accordingly.',
              severity: 'warning',
              icon: AlertCircle,
              color: 'yellow'
            },
            {
              ...
              description: 'Your average order value is 15% higher than industry average, indicating strong customer satisfaction.',
              severity: 'success',
              icon: Target,
              color: 'green'
            }
